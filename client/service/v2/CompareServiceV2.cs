...
namespace FrsSDK.client.service
{
    public class CompareServiceV2
    {
        ...
        public CompareServiceV2(AccessService accessService, string projectId)
        {
        ...
        private CompareFaceResult CompareFace(string image1, string image2, ImageType imageType)
        {
            ...
            HttpWebResponse response = this.accessService.Post(uri, null, HttpUtils.ObjToData(jsonObj), FrsConstantV2.TYPE_JSON);
