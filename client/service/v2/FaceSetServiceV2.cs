...
{
    public class FaceSetServiceV2
    {
        private readonly AccessService accessService;
        private readonly String projectId;

        public FaceSetServiceV2(AccessService accessService, String projectId)
        {
        ...
        {
            string uri = String.Format(FrsConstantV2.FACE_SET_CREATE_URI, projectId);
        ...
        {
            string uri = String.Format(FrsConstantV2.FACE_SET_GET_ALL_URI, projectId);
        ...
        {
            string uri = String.Format(FrsConstantV2.FACE_SET_GET_ONE_URI, projectId, faceSetName);
            HttpWebResponse response = accessService.Get(uri);
        ...
        {
            string uri = String.Format(FrsConstantV2.FACE_SET_DELETE_URI, projectId, faceSetName);
