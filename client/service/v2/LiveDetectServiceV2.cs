...
namespace FrsSDK.client.service
{
    public class LiveDetectServiceV2
    {
        ...
        public LiveDetectServiceV2(AccessService accessService, String projectId)
        {
        ...
        {
            string uri = String.Format(FrsConstantV2.LIVE_DETECT_URI, projectId);
        ...
        {
            string uri = string.Format(FrsConstantV2.LIVE_DETECT_URI, this.projectId);
