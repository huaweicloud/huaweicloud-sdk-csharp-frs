...
namespace FrsSDK.client.service
{
    public class FaceService
    {
        ...
        public FaceService(AccessService accessService, String projectId)
        {
        ...
        {
            string uri = String.Format(FrsConstant.FACE_ADD_URI, projectId, faceSetName);
        ...
        {
            string uri = string.Format(FrsConstant.FACE_ADD_URI, this.projectId, faceSetName);
        ...
        {
            string uri = String.Format(FrsConstant.FACE_GET_RANGE_URI, projectId, faceSetName, offset, limit);
        ...
        {
            string uri = String.Format(FrsConstant.FACE_GET_ONE_URI, projectId, faceSetName, faceId);
            HttpWebResponse response = accessService.Get(uri);
            return HttpUtils.ResponseToObj<GetFaceResult>(response);
        }
        ...
        {
            string uri = String.Format(FrsConstant.FACE_DELETE_BY_FACE_ID_URI, projectId, faceSetName, faceId);
        ...
        {
            string uri = String.Format(FrsConstant.FACE_DELETE_BY_EXT_ID_URI, projectId, faceSetName, externalImageId);
            HttpWebResponse response = accessService.Delete(uri);
            return HttpUtils.ResponseToObj<DeleteFaceResult>(response);
        }
        ...
        {
            string uri = String.Format(FrsConstant.FACE_DELETE_BY_FIELD_ID_URI, projectId, faceSetName, fieldName, fieldValue);
            HttpWebResponse response = accessService.Delete(uri);
            return HttpUtils.ResponseToObj<DeleteFaceResult>(response);
        }
    }
