...
namespace FrsSDK.client.service
{
    public class SearchService
    {
        ...
        public SearchService(AccessService accessService, string projectId)
        {
        ...
        {
            string uri = string.Format(FrsConstant.FACE_SEARCH_URI, projectId, faceSetName);
        ...
        public SearchFaceResult SearchFaceByFile(string faceSetName, string imagePath, int topN, double threshold,
            SearchSort searchSort, SearchReturnFields searchReturnFields, string filter)
        {
            string uri = string.Format(FrsConstant.FACE_SEARCH_URI, this.projectId, faceSetName);
